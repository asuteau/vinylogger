...
const Logo = ({className, color = 'dark'}: LogoProps) => {
  return (
    <section id="logo" className={`flex gap-4 items-center font-logo ${className}`}>
      <VinylRecord size={48} weight="duotone" className={color === 'light' ? 'fill-slate-100' : 'fill-slate-900'} />
